...
//	function to add the student into the database
	protected static void insertStudent(String id,String name,String fatherName,
		...
		String query = "INSERT INTO students(student_id,student_name,father_name,student_dob,student_gender,student_contact,student_email,section,student_address) "
					+ "VALUES("
						+"'"+ id +"',"
						+"'"+ name +"',"
						+"'"+ fatherName +"',"
